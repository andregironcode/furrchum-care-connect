...
const VetDirectory = () => {
  ...
  const filteredVets = vets.filter(vet => {
    const matchesSearch = vet.name.toLowerCase().includes(searchTerm.toLowerCase()) || vet.specialization.toLowerCase().includes(searchTerm.toLowerCase());
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="mt-4 flex justify-between items-center">
            <Button className="text-white bg-orange-500 hover:bg-orange-400">
              🔍 Find Nearest Vet
            </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredVets.map(vet => <div key={vet.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
        ...
        {filteredVets.length === 0 && <div className="text-center py-12">
            <p className="text-slate-600 text-lg">No veterinarians found matching your criteria.</p>
            <Button className="mt-4 bg-indigo-600 hover:bg-indigo-700" onClick={() => {
          setSearchTerm('');
