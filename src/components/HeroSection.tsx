...
const HeroSection = () => {
  return (
    <div className="relative overflow-hidden bg-primary py-24 sm:py-32">
      ...
      <div className="absolute -right-20 top-40 w-80 h-80 bg-accent/20 rounded-full blur-3xl"></div>
      <div className="absolute -left-20 bottom-20 w-80 h-80 bg-[#4e2a14]/10 rounded-full blur-3xl"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl text-[#4e2a14]/90 mb-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-2 border-[#4e2a14] text-[#4e2a14] hover:bg-[#4e2a14] hover:text-white px-8 py-6 text-lg h-auto font-semibold"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
            <Card className="bg-white/80 backdrop-blur-sm border-none shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in group overflow-hidden">
              <CardContent className="p-8 text-center relative">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-semibold text-[#4e2a14] mb-3">Instant Access</h3>
                  <p className="text-[#4e2a14]/80">Connect with available vets in under 5 minutes, 24/7</p>
                </div>
              </CardContent>
            </Card>
            ...
            >
              <CardContent className="p-8 text-center relative">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-semibold text-[#4e2a14] mb-3">Certified Vets</h3>
                  <p className="text-[#4e2a14]/80">Licensed professionals with years of experience</p>
                </div>
              </CardContent>
            </Card>
            ...
            >
              <CardContent className="p-8 text-center relative">
                <div className="absolute inset-0 bg-gradient-to-br from-transparent to-accent/5 pointer-events-none"></div>
                <div className="relative z-10">
                  <div className="w-16 h-16 bg-[#f5c75f] rounded-xl flex items-center justify-center mx-auto mb-6 shadow-md group-hover:scale-110 transition-transform duration-300">
                    <span className="text-3xl">💰</span>
                  </div>
                  <h3 className="text-xl font-semibold text-[#4e2a14] mb-3">Affordable Care</h3>
                  <p className="text-[#4e2a14]/80">Quality veterinary care at transparent, fair prices</p>
                </div>
              </CardContent>
            </Card>
          </div>
